package dev.lazurite.rayon.example.init;

import dev.lazurite.rayon.impl.CarryOn;
import dev.lazurite.rayon.example.entity.PhysicsFallingBlock;
...
{
	private static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, CarryOn.MOD_ID);
